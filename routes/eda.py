...
def header():
    ...
    col1.write("### Separación del dataset")
    ...
    col1.write("### Ditribución de categorías")
    ...
    col1.write("### Conclusiones")
    
    col1.write("La distribución de los datos por entrenamiento, validación y test sigue unas proporciones muy estandar y acorda a las buenas \
